...
1. **Potenciar el uso de herramientas hipertextuales:** Para articular creativamente lo virtual y lo presencial, reconociendo los saberes previos de los estudiantes.
    
2. **Heterogeneidad en habilidades:** Diferencias marcadas en lectoescritura, técnicas de estudio y manejo tecnológico, que exigen dinámicas adaptativas y motivadoras.
    
3. **Vinculación teoría-práctica:** Cómo conectar efectivamente contenidos académicos con prácticas profesionales específicas y analizar críticamente la tensión entre soberanía tecnológica y el utilitarismo de las "profesiones invisibles".
