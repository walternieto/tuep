...
**Idea central:**  
El punto de partida es el debate sobre el futuro del trabajo y cómo este nos obliga a repensar el concepto de _calificación laboral_. Catalano se apoya en la Sociología del Trabajo para reflexionar sobre una preocupación histórica: la tendencia a la **descalificación** del trabajador, especialmente cuando el avance tecnológico le quita control, autonomía y saber sobre su tarea.
...
- **Clasificación de tareas (según Apella y Zunino, 2017):**
    ...
    4. **Tareas cognitivas no rutinarias:**
